...
module.exports = function( app )
{
  ...
  // Authentication user
  var authenticate = function( request, response, next, valid_token = true )
  {
    ...
    // Check user credentials
      ...
      Users.attemptLogin( user_cred.name, user_cred.pass ).then(
  ...
  // Check users tokens
  var check_token = function( request, response, next )
  {
    ...
    if( token )
    {
      jwt.verify( token.toString( 'hex' ), jwt_info.key,
