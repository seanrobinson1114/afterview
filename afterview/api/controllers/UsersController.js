/*
 * Contains all queries that will be exposed through restful endpoints for users collection
 * author@ sean
 */
...
module.exports = {
  ...
  attemptLogin: ( username, password ) => {
    ...
    return User.find( {"username": username} ).lean().exec().then( ( user ) => {
  ...
  getLoggedInUsername: ( request, response ) => {
